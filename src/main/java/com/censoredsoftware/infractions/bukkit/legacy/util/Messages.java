...
public class Messages
{
	...
	static
	{
		LOGGER = InfractionsPlugin.getInst().getLogger();
		PLUGIN_NAME = InfractionsPlugin.getInst().getName();
	...
	public static void broadcast(String msg)
	{
		...
		{
			Server server = InfractionsPlugin.getInst().getServer();
			for(String line : wrapInGame(msg))
				server.broadcastMessage(line);
			return;
		}
		InfractionsPlugin.getInst().getServer().broadcastMessage(msg);
	}
